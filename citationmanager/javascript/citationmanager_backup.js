 ...
 */	
	...
	function renderReferences(data,key_value,count1)
	{
		...
		//alert(key_value);
		if (key_value == 0) {
			$("#public").html("UR " + citation_info[key_value].UR + "<br/>TY " + citation_info[key_value].TY + "<br/>" + "N1 " + citation_info[key_value].N1 + "<br/>TL " + citation_info[key_value].TL +"<br/>AU " + citation_info[key_value].AU + "<br/>ER"+"<br/><div aligh='right'><select id='options'><option>ELEC</option></select></div>");
		}
		else 
		{
			//alert(key_value)
			$("#public").html("UR " + citation_info[key_value].UR + "<br/>TY " + citation_info[key_value].TY + "<br/>" + "N1 " + citation_info[key_value].N1 + "<br/>TL " + citation_info[key_value].TL +"<br/>AU " + citation_info[key_value].AU + "<br/>ER"+"<br/><a href=javascript:; id='next'>Next</a>&#160;&#160;<a href=javascript:; id='previous'>Previous</a>&#160;&#160;<a href=javascript:; id='comment'>Comment</a>&#160;<textarea size=100% id='comments'></textarea><button class='s3d-button s3d-button-primary' id='add_comment'><span class='s3d-button-inner'>Add Comment</span></button>&#160;&#160;<a href=javascript:; id='delete'>Delete Citation</a>");
		}
		key_value++;
		if (key_value <= count1) {
  ...
  //alert(count1);
	...
	var doInit=function()
	{
		//$("#main-view > ul").tabs({ fx: { height: 'toggle', opacity: 'toggle' } });
